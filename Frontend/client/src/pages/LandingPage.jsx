...
const LandingPage = () => {
  return (
    <div className="landing-container">
      ...
      <p className="landing-description">
        Exploring the most overrated snacks worldwide! Vote, discuss, and discover snacks that live up to the hype—or don't.
      </p>
  ...
  <div className="snack-list">
    <div className="snack-card">
      <img src="https://m.media-amazon.com/images/I/71pS-cOBxDL._AC_UF894,1000_QL80_.jpg" alt="Spicy Takis" />
      <h3>Spicy Takis</h3>
      <p>Overhyped or the best spicy snack?</p>
    </div>
    <div className="snack-card">
      <img src="https://images.unsplash.com/photo-1555939594-58d7cb561ad1" alt="Gold-Leaf Burgers" />
      <h3>Gold-Leaf Burgers</h3>
      <p>Luxury or unnecessary?</p>
    </div>
    <div className="snack-card">
      <img src="https://images.unsplash.com/photo-1505253758473-96b7015fcd40" alt="Matcha KitKats" />
      <h3>Matcha KitKats</h3>
      <p>Do they deserve the craze?</p>
    </div>
    <div className="snack-card">
      <img src="https://www.sidechef.com/recipe/3883dffb-5fa2-4ee9-8054-d8de1409899f.jpg?d=1408x1120" alt="Pani Puri" />
